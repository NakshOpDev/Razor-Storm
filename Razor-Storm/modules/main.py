...
""")
	...
	def _add_commands(self):
		...
		event.help(["exit", "quit", "e", "q"], "Exit Razor-Storm.")
		event.help("help", "View all commands.")
		event.help("upgrade", "Upgrade Razor-Storm.")
	...
	def upgrade():
		try:
			chdir("/tmp")
			system("sudo git clone https://github.com/NakshOpDev/Razor-Storm.git")
			...
			print("Cound not upgrade Razor-Storm. (Make sure to use sudo)")
